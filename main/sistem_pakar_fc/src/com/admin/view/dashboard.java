...
public class dashboard extends javax.swing.JPanel {
    ...
    public dashboard() {
        ...
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/icon/icons8-virus-64.png")), "Penyakit",  data.totalPenyakit()));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/icon/icons8-virus-64 (1).png")), "Gejala", data.totalGejala()));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/icon/icons8-algorithm-50 (1).png")), "Rule", data.totalRule()));
        card4.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/icon/icons8-person-64.png")), "Pengguna", data.totalUser()));
