...
public class Form_G extends javax.swing.JFrame {
      ...
      private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
            MasterDataPenyakit data = new MasterDataPenyakit();
            Form_A form = new Form_A();
            data.editDataPenyakit(form.tabel_penyakit, txt_kodepenyakit, txt_namapenyakit, txt_deskripsi, txt_gejala, txt_pencegahan, txt_obat);
